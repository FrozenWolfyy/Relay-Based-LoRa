...
# specify simulation parameters
    ...
    circ_rad = 250 # radius of the circle over which the ndoes are randomly distributed (gateway-0 is at the center)
    ...
    relay_radius =  90  # radius of the circle over which the relays are randomly distributed
    ...
    for num_nodes in num_nodes_range:
        for weak_interference in range(0,1,1):
            ...
            import sys;
            sys.argv=[r'LoRa_generatesRandomData.py', str(num_nodes),str(avg_inter_frame_interval),str(exp_num),str(simulation_time),\
            ...
            exec(open(r'LoRa_generatesRandomData.py').read());
