...
power_consumed=open("powerConsumedRelayDistanceLessSimsWithoutGPSWithRelayCircleCorrectedDup17.txt","a")
power_consumed.write(str(powerConsumed/10))
power_consumed.write(',')
power_consumed.close()

fdrConsumed=open("fdrRateRelayDistanceLessSimsWithoutGPSWithRelayCircleCorrectedDup17.txt","a")
