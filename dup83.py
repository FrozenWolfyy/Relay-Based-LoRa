...
# specify simulation parameters
    ...
    circ_rad = 50+50*x # radius of the circle over which the ndoes are randomly distributed (gateway-0 is at the center)
    ...
    for num_nodes in num_nodes_range:
        for weak_interference in range(0,1,1):
            ...
            import sys;
            sys.argv=[r'LoRa_Relay_v2_dup83.py', str(num_nodes),str(avg_inter_frame_interval),str(exp_num),str(simulation_time),\
            ...
            exec(open(r'LoRa_Relay_v2_dup83.py').read());
