...
fdrVSrelayradiussinglerelay=open("fdrVSrelayradiussinglerelay.txt","a")
fdrVSrelayradiussinglerelay.write(str(totsoftots))
fdrVSrelayradiussinglerelay.write('\n')
fdrVSrelayradiussinglerelay.close()
