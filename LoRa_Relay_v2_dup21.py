...
power_consumed=open("powerConsumedRelayDistanceLessSimsWithGPSWithRelayCirclealpha07Dup21.txt","a")
power_consumed.write(str(powerConsumed/10))
power_consumed.write(',')
power_consumed.close()

fdrConsumed=open("fdrRateRelayDistanceLessSimsWithGPSWithRelayCirclealpha07Dup21.txt","a")
