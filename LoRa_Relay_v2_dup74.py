...
power_consumed=open("powerConsumedRelaysNumberNodes1000CircleRadius100Dup74.txt","a")
power_consumed.write(str(powerConsumed/10))
power_consumed.write(',')
power_consumed.close()

fdrConsumed=open("fdrRateRelaysNumberNodes1000CircleRadius100Dup74.txt","a")
