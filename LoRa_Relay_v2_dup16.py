...
power_consumed=open("powerConsumedRelayDistanceLessSimsWithGPSWithRelayCircleCorrectedDup16.txt","a")
power_consumed.write(str(powerConsumed/10))
power_consumed.write(',')
power_consumed.close()

fdrConsumed=open("fdrRateRelayDistanceLessSimsWithGPSWithRelayCircleCorrectedDup16.txt","a")
