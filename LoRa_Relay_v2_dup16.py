...
power_consumed=open("powerConsumedRelayDistanceLessSimsWithGPSWithRelayCircleDup16.txt","a")
power_consumed.write(str(powerConsumed/10))
power_consumed.write('\n')
power_consumed.close()

fdrConsumed=open("fdrRateRelayDistanceLessSimsWithGPSWithRelayCircleDup16.txt","a")
