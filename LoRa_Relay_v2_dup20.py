...
power_consumed=open("powerConsumedRelayDistanceLessSimsWithGPSWithRelayCirclealpha06Dup20.txt","a")
power_consumed.write(str(powerConsumed/10))
power_consumed.write(',')
power_consumed.close()

fdrConsumed=open("fdrRateRelayDistanceLessSimsWithGPSWithRelayCirclealpha06Dup20.txt","a")
