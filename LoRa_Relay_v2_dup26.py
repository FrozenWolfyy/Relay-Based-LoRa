...
##check the paper mentioned for d0 and Lpdld0
    ...
    total_rcvd = 0
    total_rcvd_relay = 0
    sensorPowerConsumed = 0
    for i in range(0, nrNodes):
        sensorPowerConsumed += (nodes[i].sent * nodes[i].sf)
...
# power_consumed=open("powerConsumedRelayDistanceLessSimsWithGPSWithRelayCirclealpha05Dup19.txt","a")
# power_consumed.write(str(powerConsumed/10))
# power_consumed.write(',')
# power_consumed.close()
#
# fdrConsumed=open("fdrRateRelayDistanceLessSimsWithGPSWithRelayCirclealpha05Dup19.txt","a")
# fdrConsumed.write(str(totsoftots))
# fdrConsumed.write(',')
# fdrConsumed.close()

power_consumed=open("powerConsumedRelayDistanceLessSimsWithGPSWithRelayCirclealpha1WithDynamicDup26.txt","a")
power_consumed.write(str(powerConsumed/10))
power_consumed.write(',')
power_consumed.close()

fdrConsumed=open("fdrRateRelayDistanceLessSimsWithGPSWithRelayCirclealpha1WithDynamicDup26.txt","a")
fdrConsumed.write(str(totsoftots))
fdrConsumed.write(',')
fdrConsumed.close()
