...
power_consumed=open("powerConsumedRelayDistanceLessSimsWithGPSWithRelayCirclealpha08Dup22.txt","a")
power_consumed.write(str(powerConsumed/10))
power_consumed.write(',')
power_consumed.close()

fdrConsumed=open("fdrRateRelayDistanceLessSimsWithGPSWithRelayCirclealpha08Dup22.txt","a")
