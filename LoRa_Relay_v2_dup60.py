...
for simulation_number in range(50):
...
# plt.show()
totsoftots*=2
print(totsoftots,powerConsumed/50)
...
power_consumed=open("powerConsumedAlphaVsNumberofNodesCircRadius250MoreSimsDup60.txt","a")
power_consumed.write(str(powerConsumed/50))
power_consumed.write(',')
power_consumed.close()

fdrConsumed=open("fdrRateAlphaVsNumberofNodesCircRadius250MoreSimsDup60.txt","a")
