...
for simulation_number in range(100):
    ...
    # nrBs->totol number of basestations
            ...
            for rcvr_id in range(numGateways, nrBS):
                ...
                # print(node.packet[rcvr_id].dist)
...
fdrVSrelayradiuswithoutGPSText=open("fdrVSrelayradiuswithoutGPS.txt","a")
fdrVSrelayradiuswithoutGPSText.write(str(totsoftots))
fdrVSrelayradiuswithoutGPSText.write('\n')
fdrVSrelayradiuswithoutGPSText.close()
