...
for x in range(114,250):
# specify simulation parameters
    num_nodes_range = [random.randint(50,250)] # number of nodes in the network
    ...
    relays = random.randint(0,20) # number # of relay nodes
    ...
    circ_rad = 100 # radius of the circle over which the ndoes are randomly distributed (gateway-0 is at the center)
    ...
    relay_radius =  x  # radius of the circle over which the relays are randomly distributed
    ...
    for num_nodes in num_nodes_range:
        for weak_interference in range(0,1,1):
            ...
            import sys;
            sys.argv=[r'LoRa_asap14.py', str(num_nodes),str(avg_inter_frame_interval),str(exp_num),str(simulation_time),\
            ...
            exec(open(r'LoRa_asap14.py').read());
