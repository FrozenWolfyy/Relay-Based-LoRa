...
# specify simulation parameters
    num_nodes_range = [1000] # number of nodes in the network
    ...
    relay_radius = 65  # radius of the circle over which the relays are randomly distributed
    relay_reception_time = 100*x # in ms
    relay_transmission_time = 100*x # in ms
    relay_sleep_time = 500*x # in ms
    relay_circle=1
    gpsFlag=1
    alpha = 1
    ...
    for num_nodes in num_nodes_range:
        for weak_interference in range(0,1,1):
            ...
            import sys;
            sys.argv=[r'LoRa_Relay_v2_dup76.py', str(num_nodes),str(avg_inter_frame_interval),str(exp_num),str(simulation_time),\
            ...
            exec(open(r'LoRa_Relay_v2_dup76.py').read());
