...
for simulation_number in range(10):
    ...
    if len(sys.argv) == 30:
        ...
        numRelays = random.randint(1,20) # Number of relays
        ...
        circle_radius = random.randint(10,250) # Radius of the circular region in meters
        ...
        relay_radius = random.randint(5,circle_radius) # The relays are randomly distributed over a circle
...
##check the paper mentioned for d0 and Lpdld0
    ...
    power_consumed=open("powerConsumedFromRandomGenerator.txt","a")
